...
$x^{k+1/2}=x^k+(L+D)^{-1}r^k$ e $x^{k+1}=x^{k+1/2}+(D+U)^{-1}r^{k+1/2}$, onde $r^k$ é o resíduo da iteração $k$. O livro do Saad, Iterative Methods, tem esse algoritmo explicado}
