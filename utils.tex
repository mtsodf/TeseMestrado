...
\newcommand{\dxhat}[1][ ]{\frac{\partial {#1}}{\partial \hat{x}}}
\newcommand{\dyhat}[1][ ]{\frac{\partial {#1}}{\partial \hat{y}}}
...
\newcommand{\sxx}{\sigma^{\prime\prime}_{xx}}
\newcommand{\syy}{\sigma^{\prime\prime}_{yy}}
\newcommand{\szz}{\sigma^{\prime\prime}_{zz}}
\newcommand{\sxy}{\sigma^{\prime\prime}_{xy}}
\newcommand{\sxz}{\sigma^{\prime\prime}_{xz}}
\newcommand{\syx}{\sigma^{\prime\prime}_{yx}}
\newcommand{\syz}{\sigma^{\prime\prime}_{yz}}
\newcommand{\szx}{\sigma^{\prime\prime}_{zx}}
\newcommand{\szy}{\sigma^{\prime\prime}_{zy}}
...
\newcommand{\sopnablafront}{\nabla_{|| S}}
\newcommand{\sopnablafronthat}{\hat{\nabla}_{|| S}}
...
\newcommand{\precon}{\mathbf{M}^{-1}}

\newcommand{\preconms}{\precon_{\text{ms}}}

\newcommand{\preconfine}{\precon_{\text{h}}}
...
\newcommand{\preconmult}{
   \preconms +\preconfine(\ident - \rigidmatrix \preconms)
}
...
\newcommand{\qtdessentialfine}{n_{\bar{u}}^h}
\newcommand{\freedomfine}[1][i]{d^h_i}
\newcommand{\essentialfine}[1][i]{\bar{d}^h_i}
\newcommand{\fineelementset}{\tau^h}
\newcommand{\finesolution}{\mathbf{u}^h}
\newcommand{\rigidmatrix}{\mathbf{K}^h}
\newcommand{\rigidmatrixentry}{[\rigidmatrix]_{i,j}}

\newcommand{\msfinesolution}{\mathbf{u}^h_{\textit{ms}}}

\newcommand{\qtdfreedomcoarse}{n_u^H}
\newcommand{\qtdessentialcoarse}{n_{\bar{u}}^H}
\newcommand{\basefunctioncoarse}[1][i]{ \mathbf{N}_{#1}^H }
\newcommand{\basefunctionelemcoarse}[1][i]{ {\mathbf{N}_{e_{#1}}^H} }
\newcommand{\basefunctioncoarseessential}[1][i]{ {\basefunctioncoarse[i+\qtdfreedomcoarse]}}
\newcommand{\freedomcoarse}[1][i]{d^H_{#1}}
\newcommand{\essentialcoarse}[1][i]{\bar{d}^H_{#1}}
\newcommand{\coarseelement}{T^K}
\newcommand{\coarseelementset}{\tau^H}
\newcommand{\coarsesolution}{\mathbf{u}^H}
\newcommand{\rigidmatrixcoarse}{\mathbf{K}^H}
\newcommand{\rigidmatrixcoarseentry}{[\rigidmatrixcoarse]_{i,j}}

\newcommand{\rigidmatrixelementms}{\mathbf{K}^{\coarseelement}}
\newcommand{\bee}{\mathbf{B}^e}

\newcommand{\nnzp}{ \text{nnz}_p }


\newcommand{\numelementsfine} {n_{\text{e}}^h}
\newcommand{\numelementsxfine}{n_{\text{e}_x}^h}
\newcommand{\numelementsyfine}{n_{\text{e}_y}^h}

\newcommand{\numelementscoarse} {n_{\text{e}}^H}
\newcommand{\numelementsxcoarse}{n_{\text{e}_x}^H}
\newcommand{\numelementsycoarse}{n_{\text{e}_y}^H}

\newcommand{\coarsefactor}{C_r}
\newcommand{\coarsefactorx}{C_{r_x}}
\newcommand{\coarsefactory}{C_{r_y}}
...
\newcommand{\trialcoarseaprox}{\mathcal{V}^H}
...
\newcommand{\testcoarseaprox}{\mathcal{S}^H}

\newcommand{\testdef}{\{  \mathbf{u} | \mathbf{u} \in \sobolev ^2 , \mathbf{u} = \bar{\mathbf{u}} \text{ em } \Gamma_u \}}

\newcommand{\qtdnos}{n_{\text{nós}}}

\newcommand{\kij}[2]{(\sopnabla \basefunctionfine[#1])^T \mathbf{D} \sopnabla \basefunctionfine[#2]}

\newcommand{\kije}[2]{(\sopnabla \basefunctionelem[#1])^T \mathbf{D}^e \sopnabla \basefunctionelem[#2]}


\newcommand{\intbase}[1]{\int_{-1}^{1}\int_{-1}^{1} #1 d\xi d\eta }

\newcommand{\st}{\pmb{\sigma}}

\newcommand{\neumann}{\int_{\Gamma_\sigma} \basefunctionfine \bar{\mathbf{t}}  d\Gamma}

\newcommand{\poroload}{\omeint{(\sopnabla \basefunctionfine)^T \mathbf{m} P_p}}


%TENSAO EFETIVA
\newcommand{\stef}{\st^{\prime\prime}}

%DEFORMACOES
\newcommand{\deformacao}{\pmb{\epsilon}}

%DESLOCAMENTO
\newcommand{\deslocamento}{\mathbf{u}}


%CAP SISTEMAS LINEARES AJUDA

\newcommand{\res}[1][0]{\mathbf{r}^{(#1)}}
\newcommand{\pcg}[1][0]{\mathbf{p}^{(#1)}}
\newcommand{\qcg}[1][0]{\mathbf{q}^{(#1)}}
\newcommand{\zcg}[1][0]{\mathbf{z}^{(#1)}}
\newcommand{\xcg}[1][0]{\mathbf{x}^{(#1)}}
