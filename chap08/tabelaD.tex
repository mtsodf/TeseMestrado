\begin{table}[]
\centering
\caption{Comparação de pré-condicionador aditivo contra multiplicativo para caso D utilizando como solver linear o método Bicgstab para diferentes níveis de engrossamento.}
