...
Inicialmente, é necessário atestar que o código de elementos finitos está resolvendo corretamente o operador descrito em \eqref{eq:edp_geomec}.Para isso, foi montado teste semelhante ao mostrado em \cite{irina}, que consiste em resolver o problema que possui como solução analítica apresentada na Equação \eqref{eq:irinasol} em um domínio  $L \times W$.
