...
%TODO adicionar exemplo das funções geradas com python
\begin{figure}[!htbp]
\centering
\includegraphics[width=5cm]{interrogacao.png}
...
\begin{figure}[h]
\center
\subfigure[ ]{\includegraphics[width=0.45\textwidth]{chap01/figs/prolongation/prolongation_x_total_000.png}}
\qquad
\subfigure[ ]{\includegraphics[width=0.45\textwidth]{chap01/figs/prolongation/prolongation_x_total_002.png}}
...
%TODO adicionar algoritmo de elementos
\begin{algorithmic}
